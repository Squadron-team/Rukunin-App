...
class WargaRepository {
  ...
  static List<Warga> generateDummy({int count = 40}) {
    ...
    final jobs = ['Pelajar', 'Karyawan', 'Wiraswasta', 'Ibu Rumah Tangga', 'Pensiunan', 'Petani'];
    ...
    for (var i = 1; i <= count; i++) {
      ...
      final isHead = i % 6 == 1;
      final dob = DateTime.now().subtract(Duration(days: (20 + (i % 30)) * 365));
      final place = 'Kota Contoh';
