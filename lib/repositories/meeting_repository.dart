  ...
  static List<Meeting> _generateDummy() {
    ...
    return [
      Meeting(
        ...
        description:
            '''Evaluasi menyeluruh terhadap pelaksanaan gotong royong terakhir dan pembagian jadwal piket warga, dengan tujuan meningkatkan partisipasi serta kebersihan lingkungan sekitar. Pertemuan akan membahas hambatan yang ditemui, perbaikan proses koordinasi, dan langkah-langkah lanjutan untuk menjaga area publik.
      ...
      Meeting(
        ...
        description:
            '''Pembahasan strategi meningkatkan keamanan lingkungan pada jam malam melalui penjadwalan ronda, pembentukan pos keamanan, dan koordinasi antar RT. Tujuan rapat ini adalah memperkecil risiko gangguan keamanan serta meningkatkan rasa aman warga melalui peran serta aktif komunitas.
      ...
      Meeting(
        ...
        description:
            '''Rapat internal pengurus RT untuk merencanakan dan membagi tugas persiapan acara warga mendatang. Fokus pada pembagian tanggung jawab, penyusunan timeline, serta identifikasi kebutuhan logistik agar acara dapat berjalan lancar dan aman.
      ...
      Meeting(
        ...
        location: 'Balai RT, Jalan Kenanga No.5',
        description:
            '''Koordinasi akhir menjelang pelaksanaan acara warga minggu depan, termasuk finalisasi susunan acara, konfirmasi vendor, dan pembagian tugas pada hari-H. Rapat ini memastikan semua aspek operasional siap dan penugasan jelas.
      ...
      Meeting(
        ...
        location: 'Balai RT, Jalan Mawar No.1',
        description:
            '''Diskusi terperinci mengenai perencanaan anggaran RT dan alokasi iuran warga untuk perbaikan fasilitas umum. Agenda mencakup prioritas perbaikan, estimasi biaya, dan mekanisme transparansi penggunaan dana.
      ...
      Meeting(
        ...
        location: 'Balai RT, Jalan Melati No.2',
        description:
            '''Rapat rutin bulanan yang membahas rangkuman kegiatan selama periode sebelumnya, laporan keuangan, serta rencana kerja berikutnya. Diharapkan menghasilkan keputusan operasional dan tindak lanjut yang jelas untuk bulan mendatang.
