...
class MarketplaceEditPage extends StatefulWidget {
  const MarketplaceEditPage({super.key});
...
class _MarketplaceEditPageState extends State<MarketplaceEditPage> {
  ...
  late TextEditingController sellerC;
  ...
  void didChangeDependencies() {
    ...
    if (!_isInitialized) {
      ...
      sellerC = TextEditingController(text: args['seller']);
      phoneC = TextEditingController(text: args['phone']);
      priceC = TextEditingController(text: args['price'].toString());
      stockC = TextEditingController(text: args['stock'].toString());
      descriptionC = TextEditingController(text: args['description']);
      category = args['category'];
      isService = args['category'] == 'Jasa';
