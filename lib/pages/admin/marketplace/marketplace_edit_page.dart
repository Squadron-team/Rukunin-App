...
class _MarketplaceEditPageState extends State<MarketplaceEditPage> {
  ...
  void initState() {
    ...
    sellerC = TextEditingController(text: widget.seller);
    phoneC = TextEditingController(text: widget.phone);
    priceC = TextEditingController(text: widget.price.toString());
    stockC = TextEditingController(text: widget.stock.toString());
    descriptionC = TextEditingController(text: widget.description);
    category = widget.category;
    isService = widget.category == 'Jasa';
                          ...
                          children: [
                            ...
                            DropdownButtonFormField<String>(
                              ...
                              onChanged: (v) {
                                setState(() {
                                  category = v!;
                                  if (category == 'Jasa') isService = true;
                                });
                              },
                            ),
                            const SizedBox(height: 16),
