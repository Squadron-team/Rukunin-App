...
class VerifikasiDetailPage extends StatefulWidget {
  ...
  @override
  State<VerifikasiDetailPage> createState() => _VerifikasiDetailPageState();
}
...
class _VerifikasiDetailPageState extends State<VerifikasiDetailPage>
  ...
  Future<void> _verifyWarga() async {
      ...
      SnackBar(
        content: Row(
          children: [
            ...
            Expanded(
              child: Text(
                '${widget.name} berhasil diverifikasi!',
  ...
  void _showRejectDialog() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text(
          'Apakah Anda yakin ingin menolak verifikasi untuk ${widget.name}?',
        ...
        actions: [
          ...
          ElevatedButton(
            ...
            onPressed: () {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(
                  content: const Text('Verifikasi ditolak'),
                  backgroundColor: Colors.red[600],
                  behavior: SnackBarBehavior.floating,
                ),
              );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: const RukuninAppBar(title: 'Detail Verifikasi'),
      body: LayoutBuilder(
  ...
  Widget _buildHeader() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: (_verified ? Colors.green[400]! : AppColors.primary)
                .withOpacity(0.3),
            blurRadius: 12,
      ...
      child: Row(
        children: [
          CircleAvatar(
            ...
            child: Icon(
              _verified ? Icons.verified_user : Icons.person_outline,
              size: 32,
              color: Colors.white,
            ),
          ),
        ...
        child: Row(
          ...
          children: [
            ...
            Text(
              ...
              style: TextStyle(
                color: _verified ? Colors.green[700] : Colors.orange[700],
                fontWeight: FontWeight.bold,
                fontSize: 12,
              ),
            ),
      ...
      children: [
        SizedBox(
          ...
          child: ElevatedButton.icon(
            onPressed: _isLoading ? null : _verifyWarga,
            style: ElevatedButton.styleFrom(
            ...
            label: Text(
              _isLoading ? 'Memproses...' : 'Verifikasi Warga',
              style: const TextStyle(
                fontSize: 16,
                fontWeight: FontWeight.bold,
                letterSpacing: 0.5,
