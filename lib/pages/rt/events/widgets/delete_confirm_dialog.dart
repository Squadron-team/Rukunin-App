          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text('Hapus kegiatan', style: TextStyle(fontWeight: FontWeight.w800, fontSize: 20)),
                const SizedBox(height: 8),
                const Text('Yakin ingin menghapus kegiatan ini?', textAlign: TextAlign.center),
