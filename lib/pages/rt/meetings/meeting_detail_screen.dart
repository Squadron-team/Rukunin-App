...
class _MeetingDetailScreenState extends State<MeetingDetailScreen> {
  ...
  void _toggleAttend() async {
    ...
    final updated = MeetingRepository.all().firstWhere(
      (it) => it.id == m.id,
      orElse: () => m,
    );
    setState(() {
              ...
              child: Column(
                ...
                children: [
                  ...
                  ActivityOrganizerCard(
                    name: m.attendingRTs.isNotEmpty
                        ? m.attendingRTs.first
                        : 'Panitia RT',
            ...
            children: [
              Expanded(
                child: ElevatedButton(
                  onPressed: m.dateTime.isBefore(DateTime.now())
                      ? null
                      : _toggleAttend,
