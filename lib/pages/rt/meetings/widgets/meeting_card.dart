...
class MeetingCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    String relativeLabel() {
      ...
      final b = DateTime(meeting.dateTime.year, meeting.dateTime.month, meeting.dateTime.day);
      ...
      child: ListTile(
        ...
        subtitle: Column(
          ...
          children: [
            ...
            Text(meeting.location, style: TextStyle(color: Colors.grey[700], fontSize: 12)),
          ],
        ),
        onTap: () {
          if (onTap != null) onTap!();
          ...
          if (meeting.isAttending) {
            return OutlinedButton(
              onPressed: () {
                ...
                // snackbar
                final msg = meeting.isAttending ? 'Kehadiran tercatat' : 'Kehadiran dibatalkan';
                final color = meeting.isAttending ? Colors.green : Colors.orange;
