...
import 'package:rukunin/repositories/statistik_repository.dart';

class LaporanRTScreen extends StatefulWidget {
  const LaporanRTScreen({super.key});
              ...
              child: Column(
                ...
                children: [
                  ...
                  FiltersRow(
                    ...
                    wilayah: _wilayah,
                    onPeriodeChanged: (v) =>
                        setState(() => _periode = v ?? 'Bulanan'),
                    onWilayahChanged: (v) =>
                        setState(() => _wilayah = v ?? 'Semua Wilayah'),
                  ),
                  const SizedBox(height: 12),
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Builder(
                                builder: (ctx) {
                                  final birthsTotal = births.fold<double>(
                                    0,
                                    (p, e) => p + e,
                                  );
                                  final deathsTotal = deaths.fold<double>(
                                    0,
                                    (p, e) => p + e,
                                  );
                                  return TwoBarsChart(
                    ...
                    children: [
                      Expanded(
                        child: Container(
                          ...
                          child: Builder(
                            builder: (ctx) {
                              final berpenghuni = houseSegments.isNotEmpty
                                  ? houseSegments[0].value
                                  : 0.0;
                              final kosong = houseSegments.length > 1
                                  ? houseSegments[1].value
                                  : 0.0;
                              final map = {
                              ...
                              return Column(
                                ...
                                children: [
                                  ...
                                  SizedBox(
                                    height: 220,
                                    child: MiniDonutCard(title: '', data: map),
                                  ),
                                ],
                              );
                            },
                          ...
                          child: Builder(
                            builder: (ctx) {
                              final berpenghuni = houseSegments.isNotEmpty
                                  ? houseSegments[0].value
                                  : 0.0;
                              final kontrak = houseSegments.length > 2
                                  ? houseSegments[2].value
                                  : 0.0;
                              final tetap = (berpenghuni - kontrak).clamp(
                                0.0,
                                berpenghuni + kontrak,
                              );
            ...
            onTap: () {
              ...
              if (mounted) {
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(content: Text('Memulai unduh Laporan RT...')),
                );
              }
            },
            borderRadius: BorderRadius.circular(12),
