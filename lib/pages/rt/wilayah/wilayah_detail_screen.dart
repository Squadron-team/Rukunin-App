            ...
            Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (c, i) {
                  ...
                  final houseStatus =
                      (houseResidents.isEmpty &&
                          (addedHouse.id.isEmpty || !addedHouse.isOccupied))
                      ? 'Kosong'
                      : 'Berpenghuni';
                    ...
                    onTap: () {
                      showDialog(
                        ...
                        builder: (dialogContext) {
                          final maxHeight =
                              MediaQuery.of(dialogContext).size.height * 0.75;
                          ...
                          final desiredHeight =
                              baseHeight + (families.length * perFamily);
                          final dialogMaxHeight = desiredHeight.clamp(
                            140.0,
                            maxHeight,
                          );
                          return Dialog(
