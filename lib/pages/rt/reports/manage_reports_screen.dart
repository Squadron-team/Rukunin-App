        ...
        return Padding(
          ...
          child: Container(
            ...
            child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
              const Text('Tambahkan Catatan', style: TextStyle(fontWeight: FontWeight.w700, fontSize: 16)),
              const SizedBox(height: 12),
              TextField(controller: controller, maxLines: 4, decoration: buildInputDecoration('Catatan')),
              const SizedBox(height: 14),
              Row(children: [
                Expanded(
                  child: OutlinedButton(
                    onPressed: () => Navigator.pop(ctx, null),
                    style: OutlinedButton.styleFrom(padding: const EdgeInsets.symmetric(vertical: 12), backgroundColor: Colors.white, foregroundColor: Colors.black, side: BorderSide(color: Colors.grey.shade300)),
        ...
        children: [
          ...
          Expanded(
            child: Builder(builder: (context) {
              ...
              final visible = _reports.where((r) => _filter == 'all' ? true : r.status == _filter).toList()
                ..sort((a, b) {
                  final order = {'new': 0, 'in_progress': 1, 'resolved': 2, 'rejected': 3};
                  ...
                  child: Center(
                    child: Column(mainAxisSize: MainAxisSize.min, children: [
                      Container(
                        ...
                        child: Center(
                          child: Icon(Icons.inbox, size: 40, color: AppColors.primary),
                        ),
                      ),
                      const SizedBox(height: 12),
                      const Text('Belum ada laporan', style: TextStyle(fontWeight: FontWeight.w800, fontSize: 20)),
