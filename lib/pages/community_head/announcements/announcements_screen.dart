...
class _AnnouncementsScreenState extends State<AnnouncementsScreen> {
  ...
  void _openCreate() async {
    final res = await Navigator.push(context, MaterialPageRoute(builder: (_) => const CreateAnnouncementScreen()));
              ...
              children: [
                ...
                Expanded(
                  child: _items.isEmpty
                      ? Center(child: Text('Belum ada pengumuman', style: TextStyle(color: Colors.grey[700])))
                      : ListView.separated(
        ...
        Row(crossAxisAlignment: CrossAxisAlignment.center, children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [BoxShadow(color: Colors.black.withAlpha(6), blurRadius: 3, offset: const Offset(0, 1))],
            ),
            child: Center(child: Icon(Icons.campaign, color: Colors.yellow[800], size: 20)),
          ),
