              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(children: [Icon(Icons.favorite, size: 16, color: Colors.pinkAccent), const SizedBox(width: 6), Text('$interestedCount orang tertarik', style: TextStyle(fontWeight: FontWeight.w700))]),
                  ],
                ),
              ),
            ),
